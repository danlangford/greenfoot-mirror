 ...
 * @author  Bruce Quig
 * @version $Id: Boot.java 6737 2009-09-19 08:40:03Z davmac $
 */
public class Boot
{
    ...
    // and then the update-version target should be executed.
    public static String GREENFOOT_VERSION = "1.5.6";
    ...
    private static String[] bluejJars = { "bluejcore.jar", "bluejeditor.jar", "bluejext.jar",
                                          "antlr.jar", "MRJ141Stubs.jar", "org-netbeans-lib-cvsclient.jar",
